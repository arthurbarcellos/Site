//Datas dos eventos:
var datasEventos = [
    {dia: 10, mes: 4, ano: 2020, evento: "Sexta-feira da Paixão do Senhor."},
    {dia: 12, mes: 4, ano: 2020, evento: "Domingo de Páscoa da Ressurreição do Senhor."},
    {dia: 13, mes: 5, ano: 2020, evento: "Nossa Senhora de Fátima."},
    {dia: 12, mes: 10, ano: 2020, evento: "Nossa Senhora Aparecida."},
    {dia: 25, mes: 12, ano: 2020, evento: "Natal de Nosso Senhor."}
...
function setCalendar(m) {
    ...
    document.getElementById("dates-events").innerHTML = "";
  ...
  //Number of days in month
    ...
    for(var i = 1; i <= daysInMonth((d.getMonth() + m)); i++){
        // Add event days
        for (var j = 0; j < datasEventos.length; j++){ 
            if ( i == datasEventos[j].dia && (d.getMonth() + m) == (datasEventos[j].mes - 1)){
                // If a day of event = today
                if ((i == d.getDate()) && ((d.getMonth() + m) == d.getMonth())){
                    document.getElementById("days").innerHTML += '<li><span class="active event">' + i + '</span></li>\n';
                }
                else {
                    document.getElementById("days").innerHTML += '<li><span class="event">' + i + '</span></li>\n';
                }
                document.getElementById("dates-events").innerHTML += '<li><span>' + datasEventos[j].dia + '</span><br>' + datasEventos[j].evento + '<br><br></li>\n';
                i++;
            } 
        }
        // Today
